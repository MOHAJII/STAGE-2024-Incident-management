...
<h1 class="mt-5">Mes incidents</h1>

<table id="datatable" class="display">
    <?php
    $query = "SELECT * FROM incident WHERE status = :statut and id_technicien = :id";
    $pdostmt = $pdo->prepare($query);
    $pdostmt->execute(["statut" => "en cours", "id" => $technicien["id_technicien"]]);
    ?>
    <thead>
        <tr>
            <th>ID INCIDENT</th>
        ...
        <?php while ($ligne = $pdostmt->fetch(PDO::FETCH_ASSOC)): ?>
            <tr>
                ...
                <td class="d-flex justify-content-between">
                    <a href="update_incident.php?id=<?= $ligne["id_incident"] ?>" class="btn btn-primary">
                    ...
                    <a href="delete_incident.php?id=<?= $ligne['id_incident'] ?>" class="btn btn-danger"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Voulez vous vraiment supprimer cette incident de votre liste?
                        </div>
