...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $stmt = $pdo->prepare("update incident set id_technicien = :id where id_incident = :id2");
    $stmt->execute(["id" => $technicien["id_technicien"], "id2" => $incident["id_incident"]]);
...
<div class="d-flex justify-content-between mt-4">
    ...
    <button type="submit" class="btn btn-success">Ajouter a mes incidents</button>
</div>
</form>
</div>
